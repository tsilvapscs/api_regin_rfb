...
{
    public class T73309_WS09_RFB : DBInteractionBase
    {
        #region  Property Declarations
        protected string _t73309_cpf;
        ...
        public string t73309_cpf
        {
            get { return _t73309_cpf; }
            set { _t73309_cpf = value; }
        }
        ...
        public void DeletePk()
        {
            ...
            // Codigo Update ******************* 
            SqlU.AppendLine(" Delete    from t73309_ws09_rfb ");
            SqlU.AppendLine(" Where	    t73309_cpf = @v_t73309_cpf ");
            ...
            {
                // Codigo dbParameter ******************* 
                cmdToExecute.Parameters.Add(new MySqlParameter("v_t73309_cpf", MySqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _t73309_cpf));
        ...
        public void Update()
        {
            ...
            Sql.AppendLine(" Insert into t73309_ws09_rfb");
            Sql.AppendLine("  (");
            Sql.AppendLine("	t73309_cpf, ");
            Sql.AppendLine("	t73309_data_consulta, ");
            Sql.AppendLine("	t73309_xml ");
            Sql.AppendLine("  )");
            Sql.AppendLine(" Values ");
            Sql.AppendLine("  (");
            Sql.AppendLine("	@v_t73309_cpf, ");
            Sql.AppendLine("	@v_t73309_data_consulta, ");
            Sql.AppendLine("	@v_t73309_xml ");
            Sql.AppendLine("  )");

            // Codigo Update ******************* 
            SqlU.AppendLine(" Update    t73309_ws09_rfb Set ");
            ...
            SqlU.AppendLine(" and       t73309_cpf = @v_t73309_cpf ");
            ...
            try
            {
                ...
                Sql.AppendLine(" DELETE FROM t73309_ws09_rfb WHERE t73309_data_consulta < date_sub(sysdate(), INTERVAL 5 DAY)  LIMIT 10 ");
                cmdToExecute.CommandText = Sql.ToString();
                cmdToExecute.CommandType = CommandType.Text;
                cmdToExecute.ExecuteNonQuery();
        ...
        public T73309_WS09_RFB Query()
        {
            StringBuilder SqlU = new StringBuilder();

            SqlU.AppendLine(" Select    * ");
            SqlU.AppendLine(" from      t73309_ws09_rfb ");
            SqlU.AppendLine(" Where	    t73309_cpf = @v_t73309_cpf ");
