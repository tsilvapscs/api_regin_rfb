...
{
    public class Ruc_General_sqlserver : DBInteractionBaseSQL
    {
        // Variables ******************* 
    ...
    //            cmdToExecute.Connection = _mainConnectionSQL;
                ...
                // Codigo dbParameter ******************* 
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_ruc", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_ruc));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_ttip_reg", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_ttip_reg));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_vtip_reg", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_vtip_reg));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_ttip_ctrib", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_ttip_ctrib));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_vtip_ctrib", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_vtip_ctrib));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_ttip_pers", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_ttip_pers));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_vtip_pers", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_vtip_pers));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_cgc_cpf", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_cgc_cpf));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tsc_sit_cad", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tsc_sit_cad));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tab_cod_unid", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tab_cod_unid));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_ruc_cond", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_ruc_cond));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tco_cond_pago", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tco_cond_pago));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_opt_simp", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_opt_simp));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_ind_regm_esp", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_ind_regm_esp));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_ind_subst_trib", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_ind_subst_trib));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_ttamanho", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_ttamanho));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_vtamanho", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_vtamanho));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_mes_cier_ejer", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_mes_cier_ejer));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_fec_ini_act_ec", SqlDbType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_fec_ini_act_ec));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_fec_sit_cad", SqlDbType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_fec_sit_cad));
                // cmdToExecute.Parameters.Add(new SqlParameter("v_rge_fec_actl", SqlDbType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_fec_actl));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_fec_val_ruc", SqlDbType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_fec_val_ruc));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_torig_actu", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, 154));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_vorig_actu", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, 91));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tus_cod_usr", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, "REGIN"));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_ttip_insc", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_ttip_insc));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tge_vtip_insc", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tge_vtip_insc));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_nomb", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_nomb));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_codg_mun", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_codg_mun));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tae_cod_actvd", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tae_cod_actvd));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tuf_cod_uf", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tuf_cod_uf));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_rge_tda_cod_daf", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_tda_cod_daf));
                cmdToExecute.Parameters.Add(new SqlParameter("v_rge_pra_protocolo", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _rge_pra_protocolo));
                ...
                if (cmdToExecute.ExecuteNonQuery() == 0)
                    throw new Exception("Erro ao tentar gravar na ruc_general, nao gravou nada Proto " + _rge_pra_protocolo);
            }
        }
    }
}
