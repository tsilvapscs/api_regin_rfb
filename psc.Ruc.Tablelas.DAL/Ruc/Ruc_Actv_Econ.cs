    ...
    public class Ruc_Actv_Econ : DBInteractionBaseORACLE
    {
        ...
        public void Update(OracleTransaction bd)
        {
            ...
            using (OracleCommand cmdToExecute = new OracleCommand())
            {
                ...
                Sql.AppendLine(" from   ruc_actv_econ ");
                Sql.AppendLine(" where	rae_rge_pra_protocolo = '" + _rae_rge_pra_protocolo + "'");
                Sql.AppendLine(" And    rae_tae_cod_actvd = " + _rae_tae_cod_actvd);
                ...
                Qtd = int.Parse(cmdToExecute.ExecuteScalar().ToString());
