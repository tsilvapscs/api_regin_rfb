...
{
    public class Ruc_Estab_Sqlserver : DBInteractionBaseSQL
    {
        // Variables ******************* 
        ...
        public void Update(SqlTransaction bd)
        {
            ...
            using (SqlCommand cmdToExecute = new SqlCommand())
            {
                ...
                // Codigo dbParameter ******************* 
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_ide_estab", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_ide_estab));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tip_estab", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tip_estab));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tge_ttip_reg", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tge_ttip_reg));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tge_vtip_reg", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tge_vtip_reg));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tge_tcond_uso", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tge_tcond_uso));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tge_vcond_uso", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tge_vcond_uso));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_sigl", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_sigl));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_area", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_area));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tge_tuni_medid", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tge_tuni_medid));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tge_vuni_medid", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tge_vuni_medid));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_res_fec_inic", OracleType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_fec_inic));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_res_fec_fin", OracleType.DateTime, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_fec_fin));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_nume", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_nume));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_res_caja_po", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_caja_po));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_res_zona_caja_po", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_zona_caja_po));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tus_cod_usr", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tus_cod_usr));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_nom_estab", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_nom_estab));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_res_num_reg_prop", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_num_reg_prop));
                //cmdToExecute.Parameters.Add(new SqlParameter("v_res_quad_lote", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_quad_lote));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_ident_comp", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_ident_comp));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_refer", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_refer));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_ttl_tip_logradoro", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_ttl_tip_logradoro));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_direccion", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_direccion));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_urbanizacion", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_urbanizacion));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tes_cod_estado", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tes_cod_estado));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_zona_postal", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_zona_postal));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_tmu_cod_mun", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_tmu_cod_mun));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_rge_pra_protocolo", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_rge_pra_protocolo));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_nire_sede", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_nire_sede));
                cmdToExecute.Parameters.Add(new SqlParameter("v_res_cnpj_sede", SqlDbType.VarChar, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _res_cnpj_sede));
